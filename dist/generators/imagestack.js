...
async function generateLayerImages(layerName, asset, config, imagesetDir, isAppStore, iconSourceSize) {
...
export async function generateImageStack(parentDir, asset, config, iconSourceSize) {
    if (!asset.enabled)
        return;
